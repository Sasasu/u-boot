...
#elif CONFIG_CONS_INDEX == 4 && defined(CONFIG_MACH_SUN8I_T113)
	sunxi_gpio_set_cfgpin(SUNXI_GPB(6), SUN8I_T113_GPB_UART3);
	sunxi_gpio_set_cfgpin(SUNXI_GPB(7), SUN8I_T113_GPB_UART3);
